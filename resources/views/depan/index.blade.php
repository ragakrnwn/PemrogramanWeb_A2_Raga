    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                @else
                    <div class="lead mb-5">No content available</div>
                @endif
        ...
        <section class="resume-section" id="interests">
            <div class="resume-section-content">
                <h2 class="mb-5">{{ $interest ? $interest->judul : 'No Interests Available' }}</h2>
                @if($interest)
                    {{ $interest->isi }}
                @else
        ...
        <section class="resume-section" id="awards">
            <div class="resume-section-content">
                <h2 class="mb-5">{{ $award ? $award->judul : 'No Awards Available' }}</h2>
                @if($award)
